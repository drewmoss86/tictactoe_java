...
public class TicTacToe {
	...
	public static int movesLeft = moveTracker.length;
    ...
    public static void setp1Name(String p1Name) { player1Name = p1Name; }
    public static void setp2Name(String p2Name) { player2Name = p2Name; }
    public static String getp1Name() { return player1Name; }
    public static String getp2Name() { return player2Name; }
...
//        System.out.println("|-----|");
    ...
    public static String computerAlgo(String [][] grid) {

		String computerMove = "";

		//top horizontal block
		if(moveTracker[0] != null && moveTracker[1] != null && moveTracker[2] == null && moveTracker[0].equals("X") && moveTracker[1].equals("X"))
		...
		else if(moveTracker[0] != null && moveTracker[1] != null && moveTracker[2] == null &&moveTracker[0].equals("O") && moveTracker[1].equals("O"))
			computerMove = Integer.toString(2);
		else if(moveTracker[0] != null && moveTracker[2] != null && moveTracker[1] == null && moveTracker[0].equals("O") && moveTracker[2].equals("O"))
			computerMove = Integer.toString(1);
		else if(moveTracker[1] != null && moveTracker[2] != null && moveTracker[0] == null && moveTracker[1].equals("O") && moveTracker[2].equals("O"))
			computerMove = Integer.toString(0);
		//mid horizontal finish
		else if(moveTracker[3] != null && moveTracker[4] != null && moveTracker[5] == null && moveTracker[3].equals("O") && moveTracker[4].equals("O"))
			computerMove = Integer.toString(5);
		else if(moveTracker[3] != null && moveTracker[5] != null && moveTracker[4] == null && moveTracker[3].equals("O") && moveTracker[5].equals("O"))
			computerMove = Integer.toString(4);
		else if(moveTracker[4] != null && moveTracker[5] != null && moveTracker[3] == null && moveTracker[4].equals("O") && moveTracker[5].equals("O"))
			computerMove = Integer.toString(3);
    ...
    public static void playerComputer(String[][] grid) {
    	...
    	String computerMove = computerAlgo(grid);
    ...
    public static boolean checkWinner(String grid[][]) {
       ...
       //for testing
//       for(int i = 0; i < 9; i++) {
//    	   System.out.print(moveTracker[i] + " | ");
//       }
//	   System.out.println("movesleft: " + movesLeft);
    ...
    public static void player1(Scanner input, String[][] grid) {
    	...
    	if(player1_turn) { System.out.println(getp1Name() + "'s" + " move"); } 
    ...
    public static void player2(Scanner input, String[][] grid) {
    	...
    	if(!player1_turn) { System.out.println(getp2Name() + "'s" + " move"); }
    ...
    public static void num_of_players(Scanner input) {
        ...
        if(Continue.equals("y")) {
        	if(playerNum.equals("2")) {
                ...
                if(same_players.equalsIgnoreCase("y")) { 
                	new_player = false; 
                	if(player2Name == null) {
            	...
            	System.out.println("Same player? Press y/Y to continue with same players or "
            			+ "press any other key to change players");  
            	same_players = input.nextLine();
    ...
    public static void saveName(String pNum, Scanner input) {
    	if(new_player) {
        	if(pNum.equals("2")) {
        		...
        		setp1Name(checkName(input));    		
        		System.out.println("Hello, " + getp1Name() + " you will be X\n");

        		System.out.println("Enter your name Player 2: ");
        		setp2Name(checkName(input));
        		System.out.println("Hello, " + getp2Name() + " you will be O");
